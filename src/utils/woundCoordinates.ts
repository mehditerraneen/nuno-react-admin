...
const BODY_REGIONS: BodyRegion[] = [
  ...
  {
    area_code: "SHOULDER_LEFT",
    x_min: 80,
    x_max: SVG_CONFIG.CENTER_LINE,
    y_min: 160,
    y_max: 220,
    view: "FRONT",
    priority: 8,
  ...
  {
    area_code: "SHOULDER_RIGHT",
    x_min: SVG_CONFIG.CENTER_LINE,
    x_max: 432,
    y_min: 160,
    y_max: 220,
    view: "FRONT",
  ...
  // Legs - Left side
  {
    area_code: "THIGH_LEFT",
    x_min: 140,
    x_max: SVG_CONFIG.CENTER_LINE + 20,
    y_min: 500,
    y_max: 680,
    view: "FRONT",
    priority: 7,
  },
  {
    area_code: "KNEE_LEFT",
    x_min: 150,
    x_max: SVG_CONFIG.CENTER_LINE + 15,
    y_min: 680,
    y_max: 740,
    view: "FRONT",
    priority: 7,
  },
  {
    area_code: "SHIN_LEFT",
    x_min: 155,
    x_max: SVG_CONFIG.CENTER_LINE + 10,
    y_min: 740,
    y_max: 920,
    view: "FRONT",
    priority: 7,
  ...
  // Legs - Right side
  {
    area_code: "THIGH_RIGHT",
    x_min: SVG_CONFIG.CENTER_LINE - 20,
    x_max: 372,
    y_min: 500,
    y_max: 680,
    view: "FRONT",
  ...
  {
    area_code: "KNEE_RIGHT",
    x_min: SVG_CONFIG.CENTER_LINE - 15,
    x_max: 362,
    y_min: 680,
    y_max: 740,
    view: "FRONT",
  ...
  {
    area_code: "SHIN_RIGHT",
    x_min: SVG_CONFIG.CENTER_LINE - 10,
    x_max: 357,
    y_min: 740,
    y_max: 920,
    view: "FRONT",
 ...
 */
export function detectBodyArea(
  x: number,
  y: number,
  view: BodyView,
): BodyAreaCode {
  // Filter regions by view and sort by priority (higher first)
  const viewRegions = BODY_REGIONS.filter(
